package Inmuebles;
public class CasaConjuntoCerrado extends Inmuebles.CasaUrbana {
    ...
    public CasaConjuntoCerrado(int identificador_inmobiliario, int area,
                               String direccion, int numero_habitaciones,
                               int numero_banos, int numero_pisos, int valor_administracion,
                               boolean tiene_piscina, boolean tiene_campos_deportivos) {
